...
class AppTheme {
  ...
  static ThemeData _buildLightTheme() {
    ...
    return ThemeData(
      ...
      navigationBarTheme: NavigationBarThemeData(elevation: 0, height: 76, backgroundColor: c.bgCard,
  ...
  static ThemeData _buildDarkTheme() {
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(color: c.bgCard, elevation: 0,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20), side: BorderSide(color: c.cardBorder))),
  ...
  static InputDecorationTheme _inputDeco(AppColorsExtension c, Color focusColor) => InputDecorationTheme(
    ...
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: focusColor, width: 1.6)),
    errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: AppColors.error)),
    focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: AppColors.error, width: 1.6)),
    disabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: c.inputBorder.withOpacity(0.5))),
