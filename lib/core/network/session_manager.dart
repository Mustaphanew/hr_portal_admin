...
///
/// Responsibilities:
/// 1. Track whether admin is authenticated
...
class SessionManager {
  ...
  /// Expose storage for saving extra session data.
  ...
  Future<void> onLoginSuccess({
    ...
    await _storage.saveAdminId(adminId);
  ...
  /// Check if admin has a stored token on app startup.
