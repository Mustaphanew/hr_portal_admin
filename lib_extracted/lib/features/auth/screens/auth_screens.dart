...
class _LoginState extends State<LoginScreen> {
  ...
  final _userCtrl = TextEditingController(text: 'k.shamri@riyad-group.sa');
      ...
      body: SingleChildScrollView(child: Column(children: [
        ...
        Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            Text('البريد الإلكتروني للمدير', style: TextStyle(fontFamily: 'Cairo', 
              fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.tx2), textAlign: TextAlign.right),
            const SizedBox(height: 6),
            TextField(controller: _userCtrl, textDirection: TextDirection.rtl,
              style: TextStyle(fontFamily: 'Cairo', fontSize: 13), decoration: fieldDec('البريد أو المعرف الوظيفي')),
            const SizedBox(height: 14),
